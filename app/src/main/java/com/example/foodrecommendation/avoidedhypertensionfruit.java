...
public class avoidedhypertensionfruit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_avoidedhypertensionfruit);
        ...
        FirebaseDatabase.getInstance().getReference().child("hipertension").child("avoided").child("fruit").addValueEventListener(new ValueEventListener(){
            @Override
