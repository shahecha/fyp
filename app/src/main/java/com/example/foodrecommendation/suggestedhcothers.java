...
public class suggestedhcothers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suggestedhcothers);
        ...
        FirebaseDatabase.getInstance().getReference().child("hyperlipidemia").child("suggested").child("others").addValueEventListener(new ValueEventListener(){
            @Override
