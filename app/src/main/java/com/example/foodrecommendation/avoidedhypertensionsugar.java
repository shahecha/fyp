...
public class avoidedhypertensionsugar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_avoidedhypertensionsugar);
        ...
        FirebaseDatabase.getInstance().getReference().child("hipertension").child("avoided").child("sugar").addValueEventListener(new ValueEventListener(){
            @Override
